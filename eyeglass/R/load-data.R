...
results_estimates <- function() {
  readRDS(system.file("res-tab-all.rds", package = "eyeglass", mustWork = TRUE))
}

#' @rdname model-results
#' @export
results_trends <- function() {
  readRDS(system.file("res-tab-time-trend.rds", package = "eyeglass", mustWork = TRUE))
}

#' @rdname model-results
#' @export
results_agegroups <- function() {
  readRDS(system.file("res-tab-age-groups.rds", package = "eyeglass", mustWork = TRUE))
}
