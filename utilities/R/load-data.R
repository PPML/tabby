...
results_estimates <- function() {
  readRDS(system.file("res-tab-all.rds", package = "utilities", mustWork = TRUE))
}

#' @rdname model-results
#' @export
results_trends <- function() {
  readRDS(system.file("res-tab-time-trend.rds", package = "utilities", mustWork = TRUE))
}

#' @rdname model-results
#' @export
results_agegroups <- function() {
  readRDS(system.file("res-tab-age-groups.rds", package = "utilities", mustWork = TRUE))
}
